...
# generateConsensus
perl /data/fulongfei/git_repo/FluAB/scripts/generateConsensus.pl IonCode_0104 /data/fulongfei/git_repo/FluAB/test/IonCode_0104/variantCaller/TSVC_variants.genome.vcf /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104.genotype.txt /data/fulongfei/git_repo/FluAB/scripts/FluAB.target.bed /usr/bin/python2 /data/fulongfei/git_repo/FluAB/test/IonCode_0104/generateConsensus

# extract HA vcf for annnot
perl /data/fulongfei/git_repo/FluAB/scripts/extract_HA_variants.pl /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104.genotype.txt /data/fulongfei/git_repo/FluAB/test/IonCode_0104/variantCaller/TSVC_variants.vcf /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104_HA.vcf

# annot HA var
/data/fulongfei/git_repo/FluAB/bin/jre1.8.0_351/bin/java -jar /data/fulongfei/git_repo/FluAB/bin/snpEff/snpEff.jar -c /data/fulongfei/git_repo/FluAB/bin/snpEff/snpEff.config FluAB /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104_HA.vcf >/data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104.snpEff.annot.vcf

# Final variant annot file
perl /data/fulongfei/git_repo/FluAB/scripts/format_snpEff.pl /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104.snpEff.annot.vcf /data/fulongfei/git_repo/FluAB/test/IonCode_0104/IonCode_0104.variants.snpEff.xls
